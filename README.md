...
Achte bei deinem CLI-Einstiegspunkt (der TypeScript-Datei, die als Haupteinstieg dient) darauf, dass in der allerersten Zeile der ausführbaren JavaScript-Datei der sogenannte Shebang steht.

In deiner Quellcodedatei (z. B. `src/index.ts`) sollte ganz oben Folgendes stehen:
